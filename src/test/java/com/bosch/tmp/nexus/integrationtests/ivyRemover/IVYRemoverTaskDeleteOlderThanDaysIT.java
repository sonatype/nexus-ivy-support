...
* @author wa21190
*/
public class IVYRemoverTaskDeleteOlderThanDaysIT
 extends AbstractNexusIntegrationTest
{
    ...
    @Test
    public void testSnapRepoDeployFilesRunTaskDeleteOlderThan()
        throws IOException, Exception
    {
        ...
        //set the parameters of SnapshotRemoverTask - nothing should be deleted
        ...
        //firstly assert that the artifact "auth-mod" verion "1.0-100" is not deleted
        ...
        //secondly assert that the artifact "auth-mod" version "1.0-101" is not deleted
        ...
        //fifthly assert that the artifact "auth-api" version 0.8-100 is not deleted
        ...
        //sixthly assert that the artifact "auth-api" version "0.8-101" is not deleted
        ...
        //seventhly assert that the artifact "auth-api" version "0.8-102" is not deleted
        ...
        //eighthly assert that the artifact "auth-api" version "0.8-103" is not deleted
        ...
        //ninthly assert that there at least 8 snapshots with 2 jar files 
        ...
        Assert.assertEquals( result.size(), 16, "Results: \n" 
                                + XStreamFactory.getXmlXStream().toXML( result ) );
